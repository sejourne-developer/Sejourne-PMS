import 'package:sejourne_pms/common/widgets/texts/dotted_center_title.dart';
import 'package:sejourne_pms/features/calender/widgets/property.dart';
...
class BookingInformationSlide extends StatelessWidget {
  const BookingInformationSlide({
    super.key,
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Property(propertyImage: TImage.property,margin: EdgeInsets.zero,),
                  ...
                  PrimaryButton(
                    ...
                    onPressed: () {
                      FileStorage.writeCounter(
                          ownerInformationSubTitle.toString(),
                          "ownerInformationSubTitle.txt");
                    },
                    loading: false.obs,
                  ),
                  PrimaryButton(
